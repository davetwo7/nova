...
const Navbar = () => {
  ...
  return (
    <div className="Navbar flex justify-between items-center bg-neutral-900 py-5 gap-8">
      <div className="Logo text-rose-50 font-satoshi-medium text-3xl hover:text-rose-500 tranform-transition duration-200">
        <Link to="/">Nova*</Link>
      </div>
      <form onSubmit={handleSubmit} className="search-bar bg-neutral-800 rounded-md flex w-full h-10 items-center justify-end">
        <input
      ...
      <div className="Menu flex gap-8">
        ...
        <div className="bg-neutral-800 w-8 h-8 rounded-full cursor-pointer">
        </div>
      </div>
    </div>
  );
