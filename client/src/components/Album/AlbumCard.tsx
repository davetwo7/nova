  ...
  return (
    <div className="popular-container mt-8 flex gap-10">
      <div className="album-element">
        <Link to={`/album/${mbid}`} className="album-image border shadow-2xl rounded-sm border-neutral-600/10 bg-gradient-to-l from-neutral-900 to-rose-900/20 relative group flex gap-2 justify-center items-end">
          ...
          <div className="my-2 gap-4 w-56">
            <div className="mb-1 hover:text-rose-400 transition-colors duration-100 truncate w-full">{artist}</div>
            <div className="mb-2 truncate">
              <Link to={`/album/${mbid}`} className="text-neutral-300 font-satoshi-regular pb-2 hover:text-rose-400 transition-colors duration-100 truncate w-full">{title}</Link>
            </div>
